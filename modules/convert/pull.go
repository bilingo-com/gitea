...
// ToAPIPullRequestWithDiffAndPatchRaw assumes following fields have been assigned with valid values:
// Required - Issue
// Optional - Merger
func ToAPIPullRequestWithDiffAndPatchRaw(pr *models.PullRequest) *api.PullRequestWithDiffAndPatchRaw {
	var (
		baseBranch *git.Branch
		headBranch *git.Branch
		baseCommit *git.Commit
	...
	apiPullRequest := &api.PullRequestWithDiffAndPatchRaw{
		ID:        pr.ID,
		URL:       pr.Issue.HTMLURL(),
		Index:     pr.Index,
		Poster:    apiIssue.Poster,
